            ...
            @foreach ($list_kelurahan as $kelurahan)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('dashboard/kelurahan/show') }}" class="text-warning"><i class="far fa-edit"></i> Edit</a> |
                        <a href="{{ url('dashboard/kelurahan/show') }}" class="text-danger"><i class="far fa-trash-alt"></i> Hapus</a>
                    </td>
                </tr>  
            @endforeach  
        </table>  
