                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="email" name="telpon" type="number" class="form-control"
                                            value="<?= $row['telpon'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <select id="unit_kerja_id" name="unit_kerja_id" class="custom-select">
                                            ...
                                            foreach ($rsUnitKerja as $rowUnitKerja) {
                                                $selected = ($rowUnitKerja['id'] == $row['unit_kerja_id']) ? 'selected' : ''; // Periksa apakah unit kerja ini yang dipilih sebelumnya
