                        ...
                        <div class="card-body table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    // Bikin Query SQL dengan JOIN antara tabel periksa, pasien, dan dokter
                                    $query = $dbh->query("SELECT periksa.*, pasien.nama AS nama_pasien, dokter.nama AS nama_dokter 
                                                            FROM periksa 
